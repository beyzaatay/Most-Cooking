...
class RecipesDetailSlider extends StatefulWidget {
  const RecipesDetailSlider({Key? key}) : super(key: key);

  @override
  State<RecipesDetailSlider> createState() => _CarouselSliderWidgetState();
}

class _CarouselSliderWidgetState extends State<RecipesDetailSlider> {
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              height: 250, // Slider'ın yüksekliğini artırdım
